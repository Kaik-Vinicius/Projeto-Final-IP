...
LIMITE_ESQUERDO_CAMPO_NEYMAR = OFFSET_X + 20
LIMITE_DIREITO_CAMPO_NEYMAR = OFFSET_X + LARGURA_CAMPO_JOGAVEL - 20
LIMITE_SUPERIOR_CAMPO_NEYMAR = RECUO_LINHA_FUNDO + 20
LIMITE_INFERIOR_CAMPO_NEYMAR = ALTURA_CAMPO_JOGAVEL 
